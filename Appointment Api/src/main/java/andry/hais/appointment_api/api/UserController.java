...
import andry.hais.appointment_api.component.UserIdentity;
import andry.hais.appointment_api.config.JWT.JwtProvider;
import andry.hais.appointment_api.models.User;
import andry.hais.appointment_api.service.UserService;
import andry.hais.appointment_api.vo.request.LoginForm;
import andry.hais.appointment_api.vo.response.JwtResponse;
...
public class UserController {
    ...
    public ResponseEntity<User> test() {
        String c ="email1@gmail.com";
            return ResponseEntity.ok(userService.findOne(c));
    }
}
